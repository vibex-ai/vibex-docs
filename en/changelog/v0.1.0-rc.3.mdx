---
title: "v0.1.0-rc.3"
description: "Vibex v0.1.0-rc.3 release notes: the remote authority takes over the workbench, connection-link pairing, the gpui-kit migration, and model limits."
---

<Update label="v0.1.0-rc.3" description="September 12, 2026 · 91 commits · v0.1.0-rc.2...v0.1.0-rc.3" tags={["Remote & server", "Desktop", "Mobile"]}>
