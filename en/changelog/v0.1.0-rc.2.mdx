---
title: "v0.1.0-rc.2"
description: "Vibex v0.1.0-rc.2 release notes: the cloud headless runtime, desktop client mode, cloud deployment, and the mobile overhaul."
---

<Update label="v0.1.0-rc.2" description="September 10, 2026 · 42 commits · v0.1.0-rc.1...v0.1.0-rc.2" tags={["Remote & server", "Desktop", "Mobile", "Theme & platform"]}>
