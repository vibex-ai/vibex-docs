...
Controls the theme (System / Light / Dark), window zoom (75%–200%), the size and weight of the **Interface font** and **Code font**, **Reduced motion**, and **High contrast**. The code font also applies to code blocks, the integrated editor, and the terminal.

Whether **Frosted glass** is available depends on whether the platform supports background blur (Windows does not). Fonts are listed from those installed on the system, with a fallback when one is missing.
